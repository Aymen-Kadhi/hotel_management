...
export class RoomApi {
  ...
  static findManyByHotelId(
    ...
    return HttpService.api.get(
      `/v1/hotels/hotel/${hotelId}/rooms${buildOptions}`,
    )
  }

  static createOneByHotelId(
    hotelId: string,
    values: Partial<Room>,
  ): Promise<Room> {
    return HttpService.api.post(`/v1/hotels/hotel/${hotelId}/rooms`, values)
  }
}
